...
def products_links_file_name(search_string):
	products_folder_path = '/home/ostap/Documents/programming/Saad2/products_lists'
...
def sellers_list_file_name(search_string):
	...
	sellers_folder_path = '/home/ostap/Documents/programming/Saad2/sellers_lists'
...
def save_products_links(search_string):
	...
	if file_name[0] not in os.listdir('/home/ostap/Documents/programming/Saad2/products_lists/'):
...
def merge_hits():
	...
	try:
		...
		for filename in os.listdir('/home/ostap/Documents/programming/Saad2/sellers_lists'):
...
def make_xlsx_file():
	...
	workbook = xlsxwriter.Workbook('sellers-list-ebay2.xlsx')
