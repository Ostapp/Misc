    ...
    class DnsShopLiveSearchStrategy:
        ...
        def search(self, search_string):
            ...
            result = {'website': 'dns-shop.ru', 'hits': [], 'count': 0}

            headers = {'User-Agent': "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36"}

            try:

                url = "http://www.dns-shop.ru/search/?q=" + search_string
                    ...
                    for item in prodlist:
                        try:
                            ...
                            result['hits'].append({
                                ...
                                'item_id': 'dns_shop-' + hashlib.md5(prodid.encode()).hexdigest()[:10]
                            })
        ...
        def parse(self, url):
            ...
            result = {'website': 'dns-shop.ru', 'hits': [], 'count': 0, 'message': ''}
    ...
    if __name__ == "__main__":
        strategy = DnsShopLiveSearchStrategy()
        print('\nSEARCH TEST')
